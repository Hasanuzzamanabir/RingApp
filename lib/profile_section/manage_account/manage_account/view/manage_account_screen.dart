        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              // গ্লোবাল প্রোফাইল কন্ট্রোলার পাস করা হলো
              _header(profileController),
...
Widget _header(ProfileController controller) {
  return Container(
    ...
    child: Row(
      children: [
        // আপনার কাস্টম profileAvatar উইজেটটি এখানে কল করা হলো (রেডিয়াস ৩৫)
        profileAvatar(controller, 35),
        
        SizedBox(width: 25.w),
        
        // রিয়েল-টাইম নাম আপডেটের জন্য Obx
        Obx(() => Text(
              controller.username.value,
              style: TextStyle(
                fontSize: 18.sp,
