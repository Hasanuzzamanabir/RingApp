...
class RingExchangePurchaseUnSuccessScreen extends StatelessWidget {
  const RingExchangePurchaseUnSuccessScreen({super.key});
           ...
           CustomBackButtonwidget(
              ...
              Column(
                children: [
                  ...
                  Text(
                    "Failed",
                    style: TextStyle(fontSize: 20.sp, fontWeight: FontWeight.w600, color: AppColors.readColor),
                  ),
                  SizedBox(height: 190.h),
                  Padding(
                    padding: const EdgeInsets.all(24.0),
                    child: CustomButtonWidget(
                      title: "Return to Ring Exchange",
                      onTap: () {
                        Get.offNamed(AppRoute.ringExchangeScreen);
                      },
                    ),
                  ),
                ],
