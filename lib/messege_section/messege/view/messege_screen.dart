              ...
              child: Obx(() {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      onTap: () async {
                        // Get.toNamed-কে await করা হলো যাতে ইউজার চ্যাট স্ক্রিন থেকে ব্যাক আসলে এই লিনিয়ার এক্সিকিউশনটি ফায়ার হয়
                        await Get.toNamed(
                          AppRoute.chatScreen,
                          arguments: {
                            'name': displayName, 
                        ...
                        // ইউজার ব্যাক আসামাত্রই মেসেজ লিস্টের এপিআই আবার কল হয়ে লেটেস্ট চ্যাট সিঙ্ক করে নিবে
